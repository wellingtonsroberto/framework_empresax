...
GlobalConfig::$CONNECTION_SETTING->DBName = "empresax";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "123456";
...
/** the root url of the application with trailing slash, for example http://localhost/empresax/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'empresax/';
